...
module soc_system_mm_interconnect_2 (
	...
	wire    [7:0] cmd_mux_002_src_channel;                                                    // cmd_mux_002:src_channel -> alt_vip_vfr_hdmi_avalon_slave_agent:cp_channel
	...
	wire   [31:0] miner_0_avalon_slave_agent_m0_address;                                      // miner_0_avalon_slave_agent:m0_address -> miner_0_avalon_slave_translator:uav_address
	...
	wire  [106:0] miner_0_avalon_slave_agent_rf_source_data;                                  // miner_0_avalon_slave_agent:rf_source_data -> miner_0_avalon_slave_agent_rsp_fifo:in_data
	...
	wire  [106:0] miner_0_avalon_slave_agent_rsp_fifo_out_data;                               // miner_0_avalon_slave_agent_rsp_fifo:out_data -> miner_0_avalon_slave_agent:rf_sink_data
	...
	wire          cmd_mux_003_src_valid;                                                      // cmd_mux_003:src_valid -> miner_0_avalon_slave_agent:cp_valid
	wire  [105:0] cmd_mux_003_src_data;                                                       // cmd_mux_003:src_data -> miner_0_avalon_slave_agent:cp_data
	wire          cmd_mux_003_src_ready;                                                      // miner_0_avalon_slave_agent:cp_ready -> cmd_mux_003:src_ready
	wire    [7:0] cmd_mux_003_src_channel;                                                    // cmd_mux_003:src_channel -> miner_0_avalon_slave_agent:cp_channel
	wire          cmd_mux_003_src_startofpacket;                                              // cmd_mux_003:src_startofpacket -> miner_0_avalon_slave_agent:cp_startofpacket
	wire          cmd_mux_003_src_endofpacket;                                                // cmd_mux_003:src_endofpacket -> miner_0_avalon_slave_agent:cp_endofpacket
	...
	wire          miner_0_avalon_slave_agent_rp_valid;                                        // miner_0_avalon_slave_agent:rp_valid -> router_005:sink_valid
	wire  [105:0] miner_0_avalon_slave_agent_rp_data;                                         // miner_0_avalon_slave_agent:rp_data -> router_005:sink_data
	wire          miner_0_avalon_slave_agent_rp_ready;                                        // router_005:sink_ready -> miner_0_avalon_slave_agent:rp_ready
	wire          miner_0_avalon_slave_agent_rp_startofpacket;                                // miner_0_avalon_slave_agent:rp_startofpacket -> router_005:sink_startofpacket
	wire          miner_0_avalon_slave_agent_rp_endofpacket;                                  // miner_0_avalon_slave_agent:rp_endofpacket -> router_005:sink_endofpacket
	...
	wire          miner_0_avalon_slave_agent_rdata_fifo_src_valid;                            // miner_0_avalon_slave_agent:rdata_fifo_src_valid -> avalon_st_adapter_003:in_0_valid
	wire   [33:0] miner_0_avalon_slave_agent_rdata_fifo_src_data;                             // miner_0_avalon_slave_agent:rdata_fifo_src_data -> avalon_st_adapter_003:in_0_data
	wire          miner_0_avalon_slave_agent_rdata_fifo_src_ready;                            // avalon_st_adapter_003:in_0_ready -> miner_0_avalon_slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_003_out_0_valid;                                          // avalon_st_adapter_003:out_0_valid -> miner_0_avalon_slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_003_out_0_data;                                           // avalon_st_adapter_003:out_0_data -> miner_0_avalon_slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_003_out_0_ready;                                          // miner_0_avalon_slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter_003:out_0_ready
	wire    [0:0] avalon_st_adapter_003_out_0_error;                                          // avalon_st_adapter_003:out_0_error -> miner_0_avalon_slave_agent:rdata_fifo_sink_error
